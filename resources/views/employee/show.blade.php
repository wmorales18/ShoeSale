	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('employee.index')}}">Empleado</a></li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$employee->id}}</p>
	          <strong>Nombre</strong> {{$employee->name}}</p>
	          <strong>Apellido</strong> {{$employee->surname}}</p>
	          <strong>Salario</strong> {{$employee->salary}}</p>
	          <strong>Sucursal</strong> {{$employee->branchoffices->name}}</p>
	          <strong>Usuario</strong> {{$employee->users->email}}</p>
