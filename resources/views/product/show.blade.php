...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Empleado</h6>
	    <p>{{$product->id}}</p>
	  </li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          ...
	          <strong>Nombre</strong> {{$product->name}}</p>
	          <strong>Descripcion</strong> {{$product->description}}</p>
	          <strong>Costo Producto</strong> {{$product->product_cost}}</p>
	          <strong>Tipo Producto</strong> {{$product->typeproducts->name}}</p>
	          <strong>Color</strong> {{$product->colors->name}}</p>
	          <strong>Proveedor</strong> {{$product->suppliers->name}}</p>
	          <strong>Tamaño</strong> {{$product->sizes->name}}</p>
	      </div>
	    </div>
	  </li>
