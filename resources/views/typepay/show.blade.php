	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('typepay.index')}}">Tipo Pago</a></li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$typepay->id}}</p>
	          <strong>Nombre</strong> {{$typepay->name}}</p>
	          <strong>Descripcion</strong> {{$typepay->description}}</p>
