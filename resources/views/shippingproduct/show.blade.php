	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Envio Producto</h5>
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('shippingproduct.index')}}">Envio Producto</a></li>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Envio Producto</h6>
	    <p>{{$shippingproduct->id}}</p>
	  </li>
	  <li class="collection-item">
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$shippingproduct->id}}</p>
	          <strong>Cantidad</strong> {{$shippingproduct->quantity}}</p>
	          <strong>Tipo Envio</strong> {{$shippingproduct->typeshippings->id}}</p>
	          <strong>Envio</strong> {{$shippingproduct->shippings->id}}</p>
	          <strong>Producto Inventario</strong> {{$shippingproduct->productinventories->products->name}}</p>
	       </div>
	    </div>
	  </li>
