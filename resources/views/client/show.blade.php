	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Cliente</h5>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Cliente</h6>
	    <p>{{$client->name}}</p>
	    <p>{{$client->surname}}</p>
	    <p>{{$client->phone}}</p>
	    <p>{{$client->address}}</p>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$client->id}}</p>
	          <strong>Nombre</strong> {{$client->name}}</p>
	          <strong>Apellido</strong> {{$client->surname}}</p>
	          <strong>Telefono</strong> {{$client->phone}}</p>
	          <strong>Direccion</strong> {{$client->address}}</p>
	      </div>
	    </div>
	  </li>
