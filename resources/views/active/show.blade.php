	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('active.index')}}">Activo</a></li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$active->id}}</p>
	          <strong>Nombre</strong> {{$active->name}}</p>
	          <strong>Descripcion</strong> {{$active->surname}}</p>
	          <strong>Valor</strong> {{$active->user}}</p>
	          <strong>Tipo Activo</strong> {{$active->branchoffices->name}}</p>
	          <strong>Sucursal</strong> {{$active->branchoffices->name}}</p>
	      </div>
	    </div>
	  </li>
