	        ...
	        <tr>
	          ...
	          <td>
	          	<div class="form-group col s12">
                    ...
                    <form action="{{route('branchoffice.destroy',$branchoffice->id)}}" method="POST" style="display: inline">
                        {{method_field('DELETE')}}
                        @csrf
                        <a class="btn-flat" href="{{ route('branchoffice.show',$branchoffice->id) }}">
                            <i class="material-icons indigo-text">visibility</i>
                        </a>
                        <a class="btn-flat" href="{{ route('branchoffice.edit',$branchoffice->id) }}">
...
<div class="fixed-action-btn " style="bottom: 50px; right: 19px;">
  ...
  <ul>
    <li>
      <a href="{{route('branchoffice.create')}}" class="btn-floating blue">
