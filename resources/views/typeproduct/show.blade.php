	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Tipo Producto</h5>
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('typeproduct.index')}}">Tipo de producto</a></li>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Tipo Producto</h6>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$typeproduct->id}}</p>
	          <strong>Nombre</strong> {{$typeproduct->name}}</p>
	          <strong>Descripcion</strong> {{$typeproduct->description}}</p>
