	          ...
	          <td>
	          	<div class="form-group col s12">
                    ...
                    <form action="{{route('typeproduct.destroy',$typeproduct->id)}}" method="POST" style="display: inline">
                        {{method_field('DELETE')}}
                        @csrf
                        <a class="btn-flat" href="{{ route('typeproduct.show',$typeproduct->id) }}">
                            <i class="material-icons indigo-text">visibility</i>
                        </a>
                        <a class="btn-flat" href="{{ route('typeproduct.edit',$typeproduct->id) }}">
...
<div class="fixed-action-btn " style="bottom: 50px; right: 19px;">
  ...
  <ul>
    <li>
      <a href="{{route('typeproduct.create')}}" class="btn-floating blue">
