	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('typeshipping.index')}}">Tipo Envio</a></li>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Tipo Envio</h6>
	    <p>{{$typeshipping->name}}</p>
	  </li>
	  <li class="collection-item">
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$typeshipping->id}}</p>
	          <strong>Nombre</strong> {{$typeshipping	->name}}</p>
