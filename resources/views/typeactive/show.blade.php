	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('typeactive.index')}}">Tipo Activo</a></li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$typeactive->id}}</p>
	          <strong>Nombre</strong> {{$typeactive->name}}</p>
	          <strong>Descripcion</strong> {{$typeactive->description}}</p>
