	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Activo</h5>
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('productinventory.index')}}">Producto Inventario</a></li>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Producto Inventario</h6>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$productinventory->id}}</p>
	          <strong>Pricio Venta</strong> {{$productinventory->sale_price}}</p>
	          <strong>Cantidad</strong> {{$productinventory->quantity}}</p>
	          <strong>Producto</strong> {{$productinventory->products->name}}</p>
	          <strong>Sucursal</strong> {{$productinventory->branchoffices->name}}</p>
	      </div>
	    </div>
	  </li>
