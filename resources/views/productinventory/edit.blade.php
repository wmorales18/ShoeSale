	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Producto Inventario</h5>
...
@section('content')
    ...
    <div class="col s12 m12 l6">
    	<div class="card-panel">
    		...
    		<div class="row">
		        <form class="col s12" action="{{route('productinventory.update',$productinventory->id)}}" method="POST">
		        	{{method_field('PATCH')}}
		            @csrf
		            @include('productinventory.form')
		        </form>
