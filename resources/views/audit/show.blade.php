	...
	<div class="container">
	  <div class="row">
	    <div class="col s10 m6 l6">
	      <h5 class="breadcrumbs-title">Auditoria</h5>
...
<div class="col s12 m12 l6">
	...
	<ul id="issues-collection" class="collection z-depth-1">
	  <li class="collection-item avatar">
	    ...
	    <h6 class="collection-header m-0">Rol</h6>
	    <p>{{$audit->id}}</p>
	  </li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$audit->id}}</p>
	          <strong>Usuario</strong> {{$audit->user}}</p>
	          <strong>Factura</strong> {{$audit->bill}}</p>
	          <strong>Accion</strong> {{$audit->action}}</p>
	          <strong>Fecha</strong> {{$audit->date}}</p>
