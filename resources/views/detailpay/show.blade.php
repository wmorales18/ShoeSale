	  ...
	  <div class="row">
	    <div class="col s10 m6 l6">
	      ...
	      <ol class="breadcrumbs">
	        <li><a href="/">Home</a></li>	        
	        <li><a href="{{route('detailpay.index')}}">Detaille Pago</a></li>
	    ...
	    <div class="row">
	      <div class="col s7">
	        <p class="collections-title">
	          <strong>ID</strong> {{$detailpay->id}}</p>
	          <strong>Total</strong> {{$detailpay->total}}</p>
	          <strong>Tipo Pago</strong> {{$detailpay->typepays->name}}</p>
	          <strong>Factura</strong> {{$detailpay->bills->id}}</p>
	          </div>
	    </div>
	  </li>
